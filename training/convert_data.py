...
def load_episode(h5_path: Path, crop) -> dict:
    ...
    #
    # start_pose is this episode's own first frame, so wrt_start means "how far
    # have I turned since this episode began". testing/inference.py anchors the
    # same way (first observation after a home reset) — the two must match.
